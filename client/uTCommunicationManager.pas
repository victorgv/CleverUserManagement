...
Type
  ...
  public
    ...
    //
    constructor create(const v_URL_REST_SERVER: String);
    destructor destroy;
    //
...
constructor TCommunicationManager.create(const v_URL_REST_SERVER: String);
begin
  inherited create;
  fClientSession := NIL;
  fRESTClient := TRESTClient.Create(v_URL_REST_SERVER);
